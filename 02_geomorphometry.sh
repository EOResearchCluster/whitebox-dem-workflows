...
whitebox_tools -r=Aspect \
  --dem="$DEM" \
  -o="$OUTPUT_DIR/aspect.tif"

# Hillshade
echo "  - Creating hillshade..."
whitebox_tools -r=Hillshade \
  --dem="$DEM" \
...
whitebox_tools -r=MultidirectionalHillshade \
  --dem="$DEM" \
...
whitebox_tools -r=AverageNormalVectorAngularDeviation \
  --dem="$DEM" \
...
whitebox_tools -r=DiffFromMeanElev \
  --dem="$DEM" \
...
whitebox_tools -r=ElevPercentile \
  --dem="$DEM" \
...
whitebox_tools -r=DirectionalRelief \
  --dem="$DEM" \
...
whitebox_tools -r=ContoursFromRaster \
  --input="$DEM" \
...
whitebox_tools -r=HypsometricallyTintedHillshade \
  --dem="$DEM" \
